...
from nytimes_python_sdk.exceptions_base import ApiValueError
from nytimes_python_sdk.exceptions import ClientConfigurationError
...
conf = nytimes_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.nytimes.com/svc/books/v3" if host is None else host
        """Default Base url
        """
        ...
        if api_key:
            ...
            raise ClientConfigurationError('API Key "api-key" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("nytimes_python_sdk")
