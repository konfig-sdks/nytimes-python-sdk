...
class BaseApi(api_client.Api):
    ...
    def _get_all_best_sellers_mapped_args(
        self,
    ...
    async def _aget_all_best_sellers_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lists/full-overview.json',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_all_best_sellers_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAllBestSellersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_best_sellers(
        self,
        published_date: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_all_best_sellers_mapped_args(
            published_date=published_date,
        )
        return await self._aget_all_best_sellers_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_all_best_sellers(
        self,
        published_date: typing.Optional[str] = None,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_all_best_sellers_oapg(
            query_params=args.query,
        )

class GetAllBestSellers(BaseApi):
    ...
    async def aget_all_best_sellers(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_best_sellers(
            published_date=published_date,
            **kwargs,
        )
        if validate:
    ...
    def get_all_best_sellers(
        ...
        raw_response = self.raw.get_all_best_sellers(
            published_date=published_date,
        )
        if validate:
            return OverviewResponsePydantic(**raw_response.body)
