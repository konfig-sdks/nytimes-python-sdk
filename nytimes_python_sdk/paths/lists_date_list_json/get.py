...
from nytimes_python_sdk.model.list_get_by_date_response import ListGetByDateResponse as ListGetByDateResponseSchema

from nytimes_python_sdk.type.list_get_by_date_response import ListGetByDateResponse

from ...api_client import Dictionary
from nytimes_python_sdk.pydantic.list_get_by_date_response import ListGetByDateResponse as ListGetByDateResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ListGetByDateResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListGetByDateResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_by_date_mapped_args(
        ...
        if _list is not None:
            _path_params["list"] = _list
        args.query = _query_params
        args.path = _path_params
        return args

    async def _aget_by_date_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lists/{date}/{list}.json',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByDateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_date(
        self,
        date: str,
        _list: str,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_by_date_mapped_args(
            date=date,
            _list=_list,
            offset=offset,
        )
        return await self._aget_by_date_oapg(
    ...
    def get_by_date(
        ...
        return self._get_by_date_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByDate(BaseApi):
    ...
    async def aget_by_date(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListGetByDateResponsePydantic:
        raw_response = await self.raw.aget_by_date(
            date=date,
            _list=_list,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return ListGetByDateResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListGetByDateResponsePydantic, raw_response.body)
    ...
    def get_by_date(
        ...
        raw_response = self.raw.get_by_date(
            date=date,
            _list=_list,
            offset=offset,
        )
