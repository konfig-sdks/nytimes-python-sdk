...
from nytimes_python_sdk.model.overview_response import OverviewResponse as OverviewResponseSchema

from nytimes_python_sdk.type.overview_response import OverviewResponse

from ...api_client import Dictionary
from nytimes_python_sdk.pydantic.overview_response import OverviewResponse as OverviewResponsePydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'published_date': typing.Union[PublishedDateSchema, str, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = OverviewResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_best_sellers_overview_mapped_args(
        self,
        ...
        if published_date is not None:
            _query_params["published_date"] = published_date
        args.query = _query_params
        return args

    async def _aget_best_sellers_overview_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lists/overview.json',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_best_sellers_overview_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetBestSellersOverviewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_best_sellers_overview(
        self,
        published_date: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_best_sellers_overview_mapped_args(
            published_date=published_date,
        )
        return await self._aget_best_sellers_overview_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_best_sellers_overview(
        self,
        published_date: typing.Optional[str] = None,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_best_sellers_overview_oapg(
            query_params=args.query,
        )

class GetBestSellersOverview(BaseApi):
    ...
    async def aget_best_sellers_overview(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OverviewResponsePydantic:
        raw_response = await self.raw.aget_best_sellers_overview(
            published_date=published_date,
            **kwargs,
        )
        if validate:
            return OverviewResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OverviewResponsePydantic, raw_response.body)
    ...
    def get_best_sellers_overview(
        ...
        raw_response = self.raw.get_best_sellers_overview(
            published_date=published_date,
        )
        if validate:
            return OverviewResponsePydantic(**raw_response.body)
