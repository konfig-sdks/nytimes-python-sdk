...
from nytimes_python_sdk.model.list_get_names_response import ListGetNamesResponse as ListGetNamesResponseSchema

from nytimes_python_sdk.type.list_get_names_response import ListGetNamesResponse

from ...api_client import Dictionary
from nytimes_python_sdk.pydantic.list_get_names_response import ListGetNamesResponse as ListGetNamesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ListGetNamesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListGetNamesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_names_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_names_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/lists/names.json',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetNamesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_names(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_names_mapped_args(
        )
        return await self._aget_names_oapg(
            **kwargs,
        )
    ...
    def get_names(
        ...
        return self._get_names_oapg(
        )

class GetNames(BaseApi):

    async def aget_names(
        self,
        validate: bool = False,
        **kwargs,
    ) -> ListGetNamesResponsePydantic:
        raw_response = await self.raw.aget_names(
            **kwargs,
        )
        if validate:
            return ListGetNamesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListGetNamesResponsePydantic, raw_response.body)
    ...
    def get_names(
        ...
        raw_response = self.raw.get_names(
        )
        if validate:
            return ListGetNamesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListGetNamesResponsePydantic, raw_response.body)
