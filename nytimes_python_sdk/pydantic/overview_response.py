...
from nytimes_python_sdk.pydantic.overview_response_results import OverviewResponseResults
...
class OverviewResponse(BaseModel):
    ...
    results: typing.Optional[OverviewResponseResults] = Field(None, alias='results')
    class Config:
