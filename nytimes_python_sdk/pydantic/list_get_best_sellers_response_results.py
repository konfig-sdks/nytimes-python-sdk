...
from nytimes_python_sdk.pydantic.list_get_best_sellers_response_results_item import ListGetBestSellersResponseResultsItem

ListGetBestSellersResponseResults = typing.List[ListGetBestSellersResponseResultsItem]
