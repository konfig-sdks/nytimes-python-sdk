...
from nytimes_python_sdk.pydantic.list_get_best_sellers_response_results import ListGetBestSellersResponseResults

class ListGetBestSellersResponse(BaseModel):
    ...
    results: typing.Optional[ListGetBestSellersResponseResults] = Field(None, alias='results')
    class Config:
