...
from nytimes_python_sdk.pydantic.list_get_by_date_response_results_books_item import ListGetByDateResponseResultsBooksItem

ListGetByDateResponseResultsBooks = typing.List[ListGetByDateResponseResultsBooksItem]
