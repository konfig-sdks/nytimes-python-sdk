...
from nytimes_python_sdk.pydantic.list_get_history_response_results_item import ListGetHistoryResponseResultsItem

ListGetHistoryResponseResults = typing.List[ListGetHistoryResponseResultsItem]
