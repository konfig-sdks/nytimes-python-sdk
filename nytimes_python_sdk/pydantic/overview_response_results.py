...
from nytimes_python_sdk.pydantic.overview_response_results_lists import OverviewResponseResultsLists

class OverviewResponseResults(BaseModel):
    ...
    lists: typing.Optional[OverviewResponseResultsLists] = Field(None, alias='lists')
    class Config:
