...
from nytimes_python_sdk.pydantic.list_get_history_response_results import ListGetHistoryResponseResults

class ListGetHistoryResponse(BaseModel):
    ...
    results: typing.Optional[ListGetHistoryResponseResults] = Field(None, alias='results')
    class Config:
