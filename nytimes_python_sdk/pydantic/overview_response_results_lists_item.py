...
from nytimes_python_sdk.pydantic.overview_response_results_lists_item_books import OverviewResponseResultsListsItemBooks

class OverviewResponseResultsListsItem(BaseModel):
    ...
    list_image: typing.Optional[str] = Field(None, alias='list_image')

    books: typing.Optional[OverviewResponseResultsListsItemBooks] = Field(None, alias='books')
    class Config:
