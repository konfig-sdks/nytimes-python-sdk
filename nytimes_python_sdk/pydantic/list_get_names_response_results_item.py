...
class ListGetNamesResponseResultsItem(BaseModel):
    list_name: typing.Optional[str] = Field(None, alias='list_name')

    display_name: typing.Optional[str] = Field(None, alias='display_name')

    list_name_encoded: typing.Optional[str] = Field(None, alias='list_name_encoded')

    oldest_published_date: typing.Optional[str] = Field(None, alias='oldest_published_date')

    newest_published_date: typing.Optional[str] = Field(None, alias='newest_published_date')

    updated: typing.Optional[Literal["WEEKLY", "MONTHLY"]] = Field(None, alias='updated')
    class Config:
