...
class ListGetByDateResponseResultsBooksItemIsbnsItem(BaseModel):
    isbn10: typing.Optional[str] = Field(None, alias='isbn10')

    isbn13: typing.Optional[str] = Field(None, alias='isbn13')
    class Config:
