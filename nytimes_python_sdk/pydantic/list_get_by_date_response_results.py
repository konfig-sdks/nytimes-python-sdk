...
from nytimes_python_sdk.pydantic.list_get_by_date_response_results_books import ListGetByDateResponseResultsBooks
from nytimes_python_sdk.pydantic.list_get_by_date_response_results_corrections import ListGetByDateResponseResultsCorrections

class ListGetByDateResponseResults(BaseModel):
    ...
    normal_list_ends_at: typing.Optional[int] = Field(None, alias='normal_list_ends_at')

    updated: typing.Optional[str] = Field(None, alias='updated')

    books: typing.Optional[ListGetByDateResponseResultsBooks] = Field(None, alias='books')

    corrections: typing.Optional[ListGetByDateResponseResultsCorrections] = Field(None, alias='corrections')
    class Config:
