...
from nytimes_python_sdk.pydantic.review_get_book_reviews_response_results import ReviewGetBookReviewsResponseResults

class ReviewGetBookReviewsResponse(BaseModel):
    status: typing.Optional[str] = Field(None, alias='status')

    copyright: typing.Optional[str] = Field(None, alias='copyright')

    num_results: typing.Optional[int] = Field(None, alias='num_results')

    results: typing.Optional[ReviewGetBookReviewsResponseResults] = Field(None, alias='results')
    class Config:
