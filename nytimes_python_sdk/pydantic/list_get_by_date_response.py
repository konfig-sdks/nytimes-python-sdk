...
from nytimes_python_sdk.pydantic.list_get_by_date_response_results import ListGetByDateResponseResults

class ListGetByDateResponse(BaseModel):
    ...
    results: typing.Optional[ListGetByDateResponseResults] = Field(None, alias='results')
    class Config:
