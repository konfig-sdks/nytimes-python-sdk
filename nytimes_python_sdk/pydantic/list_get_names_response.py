...
from nytimes_python_sdk.pydantic.list_get_names_response_results import ListGetNamesResponseResults

class ListGetNamesResponse(BaseModel):
    ...
    results: typing.Optional[ListGetNamesResponseResults] = Field(None, alias='results')
    class Config:
