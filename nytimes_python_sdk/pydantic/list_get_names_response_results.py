...
from nytimes_python_sdk.pydantic.list_get_names_response_results_item import ListGetNamesResponseResultsItem

ListGetNamesResponseResults = typing.List[ListGetNamesResponseResultsItem]
