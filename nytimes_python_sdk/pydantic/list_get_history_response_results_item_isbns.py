...
from nytimes_python_sdk.pydantic.list_get_history_response_results_item_isbns_item import ListGetHistoryResponseResultsItemIsbnsItem

ListGetHistoryResponseResultsItemIsbns = typing.List[ListGetHistoryResponseResultsItemIsbnsItem]
