...
from nytimes_python_sdk.pydantic.list_get_by_date_response_results_books_item_isbns_item import ListGetByDateResponseResultsBooksItemIsbnsItem

ListGetByDateResponseResultsBooksItemIsbns = typing.List[ListGetByDateResponseResultsBooksItemIsbnsItem]
