...
from nytimes_python_sdk.type.list_get_history_response_results_item_isbns import ListGetHistoryResponseResultsItemIsbns
from nytimes_python_sdk.type.list_get_history_response_results_item_ranks_history import ListGetHistoryResponseResultsItemRanksHistory
from nytimes_python_sdk.type.list_get_history_response_results_item_reviews import ListGetHistoryResponseResultsItemReviews

class RequiredListGetHistoryResponseResultsItem(TypedDict):
    pass

class OptionalListGetHistoryResponseResultsItem(TypedDict, total=False):
    title: str
    ...
    isbns: ListGetHistoryResponseResultsItemIsbns

    ranks_history: ListGetHistoryResponseResultsItemRanksHistory

    reviews: ListGetHistoryResponseResultsItemReviews

class ListGetHistoryResponseResultsItem(RequiredListGetHistoryResponseResultsItem, OptionalListGetHistoryResponseResultsItem):
    pass
