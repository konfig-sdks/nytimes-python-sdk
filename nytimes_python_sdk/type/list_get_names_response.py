...
from nytimes_python_sdk.type.list_get_names_response_results import ListGetNamesResponseResults

class RequiredListGetNamesResponse(TypedDict):
    pass

class OptionalListGetNamesResponse(TypedDict, total=False):
    status: str
    ...
    results: ListGetNamesResponseResults

class ListGetNamesResponse(RequiredListGetNamesResponse, OptionalListGetNamesResponse):
    pass
