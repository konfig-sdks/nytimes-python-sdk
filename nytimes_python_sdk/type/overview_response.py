...
from nytimes_python_sdk.type.overview_response_results import OverviewResponseResults

class RequiredOverviewResponse(TypedDict):
    pass

class OptionalOverviewResponse(TypedDict, total=False):
    status: str
    ...
    results: OverviewResponseResults

class OverviewResponse(RequiredOverviewResponse, OptionalOverviewResponse):
    pass
