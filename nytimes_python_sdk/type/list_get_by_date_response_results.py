...
from nytimes_python_sdk.type.list_get_by_date_response_results_books import ListGetByDateResponseResultsBooks
from nytimes_python_sdk.type.list_get_by_date_response_results_corrections import ListGetByDateResponseResultsCorrections

class RequiredListGetByDateResponseResults(TypedDict):
    pass

class OptionalListGetByDateResponseResults(TypedDict, total=False):
    list_name: str
    ...
    books: ListGetByDateResponseResultsBooks

    corrections: ListGetByDateResponseResultsCorrections

class ListGetByDateResponseResults(RequiredListGetByDateResponseResults, OptionalListGetByDateResponseResults):
    pass
