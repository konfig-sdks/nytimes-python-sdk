...
from nytimes_python_sdk.type.overview_response_results_lists import OverviewResponseResultsLists

class RequiredOverviewResponseResults(TypedDict):
    pass

class OptionalOverviewResponseResults(TypedDict, total=False):
    bestsellers_date: str

    published_date: str

    lists: OverviewResponseResultsLists

class OverviewResponseResults(RequiredOverviewResponseResults, OptionalOverviewResponseResults):
    pass
