...
from nytimes_python_sdk.type.list_get_history_response_results import ListGetHistoryResponseResults

class RequiredListGetHistoryResponse(TypedDict):
    pass

class OptionalListGetHistoryResponse(TypedDict, total=False):
    status: str
    ...
    results: ListGetHistoryResponseResults

class ListGetHistoryResponse(RequiredListGetHistoryResponse, OptionalListGetHistoryResponse):
    pass
