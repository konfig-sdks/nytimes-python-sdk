...
class RequiredListGetByDateResponseResultsBooksItemIsbnsItem(TypedDict):
    pass

class OptionalListGetByDateResponseResultsBooksItemIsbnsItem(TypedDict, total=False):
    isbn10: str

    isbn13: str

class ListGetByDateResponseResultsBooksItemIsbnsItem(RequiredListGetByDateResponseResultsBooksItemIsbnsItem, OptionalListGetByDateResponseResultsBooksItemIsbnsItem):
    pass
