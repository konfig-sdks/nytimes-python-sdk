...
class RequiredListGetNamesResponseResultsItem(TypedDict):
    pass

class OptionalListGetNamesResponseResultsItem(TypedDict, total=False):
    list_name: str
...
class ListGetNamesResponseResultsItem(RequiredListGetNamesResponseResultsItem, OptionalListGetNamesResponseResultsItem):
    pass
