...
from nytimes_python_sdk.type.list_get_best_sellers_response_results import ListGetBestSellersResponseResults

class RequiredListGetBestSellersResponse(TypedDict):
    pass

class OptionalListGetBestSellersResponse(TypedDict, total=False):
    status: str
    ...
    results: ListGetBestSellersResponseResults

class ListGetBestSellersResponse(RequiredListGetBestSellersResponse, OptionalListGetBestSellersResponse):
    pass
