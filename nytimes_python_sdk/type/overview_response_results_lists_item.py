...
from nytimes_python_sdk.type.overview_response_results_lists_item_books import OverviewResponseResultsListsItemBooks

class RequiredOverviewResponseResultsListsItem(TypedDict):
    pass

class OptionalOverviewResponseResultsListsItem(TypedDict, total=False):
    list_id: int
    ...
    books: OverviewResponseResultsListsItemBooks

class OverviewResponseResultsListsItem(RequiredOverviewResponseResultsListsItem, OptionalOverviewResponseResultsListsItem):
    pass
