...
class RequiredOverviewResponseResultsListsItemBooksItem(TypedDict):
    pass

class OptionalOverviewResponseResultsListsItemBooksItem(TypedDict, total=False):
    title: str
...
class OverviewResponseResultsListsItemBooksItem(RequiredOverviewResponseResultsListsItemBooksItem, OptionalOverviewResponseResultsListsItemBooksItem):
    pass
