...
class RequiredListGetBestSellersResponseResultsItemBookDetailsItem(TypedDict):
    pass

class OptionalListGetBestSellersResponseResultsItemBookDetailsItem(TypedDict, total=False):
    title: str
...
class ListGetBestSellersResponseResultsItemBookDetailsItem(RequiredListGetBestSellersResponseResultsItemBookDetailsItem, OptionalListGetBestSellersResponseResultsItemBookDetailsItem):
    pass
