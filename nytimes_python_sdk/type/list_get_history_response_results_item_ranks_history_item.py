...
class RequiredListGetHistoryResponseResultsItemRanksHistoryItem(TypedDict):
    pass

class OptionalListGetHistoryResponseResultsItemRanksHistoryItem(TypedDict, total=False):
    primary_isbn10: str
    ...
    ranks_last_week: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    asterisk: int

    dagger: int

class ListGetHistoryResponseResultsItemRanksHistoryItem(RequiredListGetHistoryResponseResultsItemRanksHistoryItem, OptionalListGetHistoryResponseResultsItemRanksHistoryItem):
    pass
