...
class RequiredListGetBestSellersResponseResultsItemIsbnsItem(TypedDict):
    pass

class OptionalListGetBestSellersResponseResultsItemIsbnsItem(TypedDict, total=False):
    isbn10: str

    isbn13: str

class ListGetBestSellersResponseResultsItemIsbnsItem(RequiredListGetBestSellersResponseResultsItemIsbnsItem, OptionalListGetBestSellersResponseResultsItemIsbnsItem):
    pass
