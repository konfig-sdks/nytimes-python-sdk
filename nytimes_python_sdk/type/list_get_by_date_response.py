...
from nytimes_python_sdk.type.list_get_by_date_response_results import ListGetByDateResponseResults

class RequiredListGetByDateResponse(TypedDict):
    pass

class OptionalListGetByDateResponse(TypedDict, total=False):
    status: str
    ...
    results: ListGetByDateResponseResults

class ListGetByDateResponse(RequiredListGetByDateResponse, OptionalListGetByDateResponse):
    pass
