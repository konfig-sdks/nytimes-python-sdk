...
from nytimes_python_sdk.type.review_get_book_reviews_response_results_item_isbn13 import ReviewGetBookReviewsResponseResultsItemIsbn13

class RequiredReviewGetBookReviewsResponseResultsItem(TypedDict):
    pass

class OptionalReviewGetBookReviewsResponseResultsItem(TypedDict, total=False):
    summary: str
    ...
    isbn13: ReviewGetBookReviewsResponseResultsItemIsbn13

class ReviewGetBookReviewsResponseResultsItem(RequiredReviewGetBookReviewsResponseResultsItem, OptionalReviewGetBookReviewsResponseResultsItem):
    pass
