...
from nytimes_python_sdk.type.list_get_by_date_response_results_books_item_isbns import ListGetByDateResponseResultsBooksItemIsbns

class RequiredListGetByDateResponseResultsBooksItem(TypedDict):
    pass

class OptionalListGetByDateResponseResultsBooksItem(TypedDict, total=False):
    title: str
    ...
    isbns: ListGetByDateResponseResultsBooksItemIsbns

class ListGetByDateResponseResultsBooksItem(RequiredListGetByDateResponseResultsBooksItem, OptionalListGetByDateResponseResultsBooksItem):
    pass
