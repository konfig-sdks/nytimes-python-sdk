...
from nytimes_python_sdk.type.review_get_book_reviews_response_results import ReviewGetBookReviewsResponseResults

class RequiredReviewGetBookReviewsResponse(TypedDict):
    pass

class OptionalReviewGetBookReviewsResponse(TypedDict, total=False):
    status: str
    ...
    results: ReviewGetBookReviewsResponseResults

class ReviewGetBookReviewsResponse(RequiredReviewGetBookReviewsResponse, OptionalReviewGetBookReviewsResponse):
    pass
