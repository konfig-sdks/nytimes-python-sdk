...
class RequiredListGetHistoryResponseResultsItemIsbnsItem(TypedDict):
    pass

class OptionalListGetHistoryResponseResultsItemIsbnsItem(TypedDict, total=False):
    isbn10: str

    isbn13: str

class ListGetHistoryResponseResultsItemIsbnsItem(RequiredListGetHistoryResponseResultsItemIsbnsItem, OptionalListGetHistoryResponseResultsItemIsbnsItem):
    pass
