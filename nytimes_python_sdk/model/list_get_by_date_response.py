...
class ListGetByDateResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def results() -> typing.Type['ListGetByDateResponseResults']:
                return ListGetByDateResponseResults
            __annotations__ = {
                "status": status,
                "copyright": copyright,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'ListGetByDateResponseResults': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> typing.Union['ListGetByDateResponseResults', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        results: typing.Union['ListGetByDateResponseResults', schemas.Unset] = schemas.unset,
