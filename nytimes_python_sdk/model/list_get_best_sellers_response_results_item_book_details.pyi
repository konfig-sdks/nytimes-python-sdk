...
class ListGetBestSellersResponseResultsItemBookDetails(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ListGetBestSellersResponseResultsItemBookDetailsItem']:
            return ListGetBestSellersResponseResultsItemBookDetailsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ListGetBestSellersResponseResultsItemBookDetailsItem'], typing.List['ListGetBestSellersResponseResultsItemBookDetailsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ListGetBestSellersResponseResultsItemBookDetails':
    ...
    def __getitem__(self, i: int) -> 'ListGetBestSellersResponseResultsItemBookDetailsItem':
