...
class ListGetHistoryResponseResultsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def isbns() -> typing.Type['ListGetHistoryResponseResultsItemIsbns']:
                return ListGetHistoryResponseResultsItemIsbns
        
            @staticmethod
            def ranks_history() -> typing.Type['ListGetHistoryResponseResultsItemRanksHistory']:
                return ListGetHistoryResponseResultsItemRanksHistory
        
            @staticmethod
            def reviews() -> typing.Type['ListGetHistoryResponseResultsItemReviews']:
                return ListGetHistoryResponseResultsItemReviews
            __annotations__ = {
                "title": title,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["isbns"]) -> 'ListGetHistoryResponseResultsItemIsbns': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ranks_history"]) -> 'ListGetHistoryResponseResultsItemRanksHistory': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reviews"]) -> 'ListGetHistoryResponseResultsItemReviews': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "description", "contributor", "author", "contributor_note", "price", "age_group", "publisher", "isbns", "ranks_history", "reviews", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["isbns"]) -> typing.Union['ListGetHistoryResponseResultsItemIsbns', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ranks_history"]) -> typing.Union['ListGetHistoryResponseResultsItemRanksHistory', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reviews"]) -> typing.Union['ListGetHistoryResponseResultsItemReviews', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "description", "contributor", "author", "contributor_note", "price", "age_group", "publisher", "isbns", "ranks_history", "reviews", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        isbns: typing.Union['ListGetHistoryResponseResultsItemIsbns', schemas.Unset] = schemas.unset,
        ranks_history: typing.Union['ListGetHistoryResponseResultsItemRanksHistory', schemas.Unset] = schemas.unset,
        reviews: typing.Union['ListGetHistoryResponseResultsItemReviews', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ListGetHistoryResponseResultsItem':
