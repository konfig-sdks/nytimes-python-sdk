...
class OverviewResponseResultsListsItemBooksItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "description", "age_group", "author", "contributor", "contributor_note", "created_date", "price", "primary_isbn13", "primary_isbn10", "publisher", "rank", "updated_date", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "description", "age_group", "author", "contributor", "contributor_note", "created_date", "price", "primary_isbn13", "primary_isbn10", "publisher", "rank", "updated_date", ], str]):
    ...
    ) -> 'OverviewResponseResultsListsItemBooksItem':
