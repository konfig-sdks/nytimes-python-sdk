...
class ReviewGetBookReviewsResponseResults(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ReviewGetBookReviewsResponseResultsItem']:
            return ReviewGetBookReviewsResponseResultsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ReviewGetBookReviewsResponseResultsItem'], typing.List['ReviewGetBookReviewsResponseResultsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ReviewGetBookReviewsResponseResults':
    ...
    def __getitem__(self, i: int) -> 'ReviewGetBookReviewsResponseResultsItem':
