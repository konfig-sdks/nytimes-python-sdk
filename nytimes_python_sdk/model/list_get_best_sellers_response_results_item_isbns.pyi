...
class ListGetBestSellersResponseResultsItemIsbns(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ListGetBestSellersResponseResultsItemIsbnsItem']:
            return ListGetBestSellersResponseResultsItemIsbnsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ListGetBestSellersResponseResultsItemIsbnsItem'], typing.List['ListGetBestSellersResponseResultsItemIsbnsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ListGetBestSellersResponseResultsItemIsbns':
    ...
    def __getitem__(self, i: int) -> 'ListGetBestSellersResponseResultsItemIsbnsItem':
