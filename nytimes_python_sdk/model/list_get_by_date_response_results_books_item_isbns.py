...
class ListGetByDateResponseResultsBooksItemIsbns(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ListGetByDateResponseResultsBooksItemIsbnsItem']:
            return ListGetByDateResponseResultsBooksItemIsbnsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ListGetByDateResponseResultsBooksItemIsbnsItem'], typing.List['ListGetByDateResponseResultsBooksItemIsbnsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ListGetByDateResponseResultsBooksItemIsbns':
    ...
    def __getitem__(self, i: int) -> 'ListGetByDateResponseResultsBooksItemIsbnsItem':
