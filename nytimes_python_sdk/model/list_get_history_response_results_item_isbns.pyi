...
class ListGetHistoryResponseResultsItemIsbns(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ListGetHistoryResponseResultsItemIsbnsItem']:
            return ListGetHistoryResponseResultsItemIsbnsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ListGetHistoryResponseResultsItemIsbnsItem'], typing.List['ListGetHistoryResponseResultsItemIsbnsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ListGetHistoryResponseResultsItemIsbns':
    ...
    def __getitem__(self, i: int) -> 'ListGetHistoryResponseResultsItemIsbnsItem':
