...
class ListGetHistoryResponseResults(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ListGetHistoryResponseResultsItem']:
            return ListGetHistoryResponseResultsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ListGetHistoryResponseResultsItem'], typing.List['ListGetHistoryResponseResultsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ListGetHistoryResponseResults':
    ...
    def __getitem__(self, i: int) -> 'ListGetHistoryResponseResultsItem':
