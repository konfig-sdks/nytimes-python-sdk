...
class OverviewResponseResultsLists(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OverviewResponseResultsListsItem']:
            return OverviewResponseResultsListsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['OverviewResponseResultsListsItem'], typing.List['OverviewResponseResultsListsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'OverviewResponseResultsLists':
    ...
    def __getitem__(self, i: int) -> 'OverviewResponseResultsListsItem':
