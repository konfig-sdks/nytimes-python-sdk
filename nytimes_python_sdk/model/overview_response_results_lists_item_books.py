...
class OverviewResponseResultsListsItemBooks(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OverviewResponseResultsListsItemBooksItem']:
            return OverviewResponseResultsListsItemBooksItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['OverviewResponseResultsListsItemBooksItem'], typing.List['OverviewResponseResultsListsItemBooksItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'OverviewResponseResultsListsItemBooks':
    ...
    def __getitem__(self, i: int) -> 'OverviewResponseResultsListsItemBooksItem':
