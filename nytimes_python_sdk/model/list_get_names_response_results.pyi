...
class ListGetNamesResponseResults(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ListGetNamesResponseResultsItem']:
            return ListGetNamesResponseResultsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ListGetNamesResponseResultsItem'], typing.List['ListGetNamesResponseResultsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ListGetNamesResponseResults':
    ...
    def __getitem__(self, i: int) -> 'ListGetNamesResponseResultsItem':
