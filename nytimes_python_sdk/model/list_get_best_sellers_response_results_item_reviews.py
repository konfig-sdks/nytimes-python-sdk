...
class ListGetBestSellersResponseResultsItemReviews(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ListGetBestSellersResponseResultsItemReviewsItem']:
            return ListGetBestSellersResponseResultsItemReviewsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ListGetBestSellersResponseResultsItemReviewsItem'], typing.List['ListGetBestSellersResponseResultsItemReviewsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ListGetBestSellersResponseResultsItemReviews':
    ...
    def __getitem__(self, i: int) -> 'ListGetBestSellersResponseResultsItemReviewsItem':
