...
class ListGetByDateResponseResultsBooks(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ListGetByDateResponseResultsBooksItem']:
            return ListGetByDateResponseResultsBooksItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ListGetByDateResponseResultsBooksItem'], typing.List['ListGetByDateResponseResultsBooksItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ListGetByDateResponseResultsBooks':
    ...
    def __getitem__(self, i: int) -> 'ListGetByDateResponseResultsBooksItem':
