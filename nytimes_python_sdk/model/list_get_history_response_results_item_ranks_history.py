...
class ListGetHistoryResponseResultsItemRanksHistory(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ListGetHistoryResponseResultsItemRanksHistoryItem']:
            return ListGetHistoryResponseResultsItemRanksHistoryItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ListGetHistoryResponseResultsItemRanksHistoryItem'], typing.List['ListGetHistoryResponseResultsItemRanksHistoryItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ListGetHistoryResponseResultsItemRanksHistory':
    ...
    def __getitem__(self, i: int) -> 'ListGetHistoryResponseResultsItemRanksHistoryItem':
