...
class ListGetHistoryResponseResultsItemReviews(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ListGetHistoryResponseResultsItemReviewsItem']:
            return ListGetHistoryResponseResultsItemReviewsItem

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ListGetHistoryResponseResultsItemReviewsItem'], typing.List['ListGetHistoryResponseResultsItemReviewsItem']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'ListGetHistoryResponseResultsItemReviews':
    ...
    def __getitem__(self, i: int) -> 'ListGetHistoryResponseResultsItemReviewsItem':
