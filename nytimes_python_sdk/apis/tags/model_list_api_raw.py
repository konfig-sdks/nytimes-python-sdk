...
from nytimes_python_sdk.paths.lists_full_overview_json.get import GetAllBestSellersRaw
from nytimes_python_sdk.paths.lists_json.get import GetBestSellersRaw
from nytimes_python_sdk.paths.lists_overview_json.get import GetBestSellersOverviewRaw
from nytimes_python_sdk.paths.lists_date_list_json.get import GetByDateRaw
from nytimes_python_sdk.paths.lists_best_sellers_history_json.get import GetHistoryRaw
from nytimes_python_sdk.paths.lists_names_json.get import GetNamesRaw


class ModelListApiRaw(
    GetAllBestSellersRaw,
    GetBestSellersRaw,
    GetBestSellersOverviewRaw,
    GetByDateRaw,
    GetHistoryRaw,
    GetNamesRaw,
):
